...
public class ValidatorBPartner implements ModelValidator
{
	...
	private String modelChange(MBPartner bp){
		...
		String  temp = bp.get_ValueAsString("Temporario"); // PALMETAL - pegar o valor do campo temporario
		...
		if (!isValid || (bp.is_ValueChanged("IsActive") && bp.isActive())) {
			...
			if (BPTypeBR.equalsIgnoreCase("PF") && temp.equalsIgnoreCase("N")){ //PALMETAL - Adicionei a segunda condição do IF
