...
public class NfeRetRecepcao2Stub extends org.apache.axis2.client.Stub {
	...
	public static void setAmbiente(String ambiente, int C_Region_ID) {
		stubAddress = MLBRNFeWebService.getURL(MLBRNFeWebService.RETRECEPCAO,
	...
	public br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeRetRecepcao2Result nfeRetRecepcao2(
			...
			br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeDadosMsg nfeDadosMsg0,
			br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeCabecMsgE nfeCabecMsg1)
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					public void onMessage(
						...
						try {
							...
							callback.receiveResultnfeRetRecepcao2((br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeRetRecepcao2Result) object);
	...
	public static class NfeRetRecepcao2Result implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetRecepcao2",
				"nfeRetRecepcao2Result", "ns2");
		...
		public org.apache.axiom.om.OMElement getOMElement(
			...
			org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
				...
				public void serialize(
					...
					NfeRetRecepcao2Result.this.serialize(MY_QNAME, factory,
							xmlWriter);
				}
			};
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							...
							"type", namespacePrefix + ":nfeRetRecepcao2Result",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "nfeRetRecepcao2Result", xmlWriter);
				}
							...
							if (!"nfeRetRecepcao2Result".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (NfeRetRecepcao2Result) ExtensionMapper
	...
	public static class NfeCabecMsg implements
		 ...
		 * http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetRecepcao2 Namespace
		 * Prefix = ns2
		 */
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeDadosMsg param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeDadosMsg.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeRetRecepcao2Result param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeRetRecepcao2Result.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeCabecMsgE param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeCabecMsgE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeDadosMsg.class
					.equals(type)) {

				return br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeDadosMsg.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeRetRecepcao2Result.class
					.equals(type)) {

				return br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeRetRecepcao2Result.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeCabecMsgE.class
					.equals(type)) {

				return br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.NfeRetRecepcao2Stub.NfeCabecMsgE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
