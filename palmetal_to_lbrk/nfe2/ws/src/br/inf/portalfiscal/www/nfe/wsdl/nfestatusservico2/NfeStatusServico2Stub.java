...
public class NfeStatusServico2Stub extends org.apache.axis2.client.Stub {
	...
	public static void setAmbiente(String ambiente, int C_Region_ID) {
		stubAddress = MLBRNFeWebService.getURL(MLBRNFeWebService.STATUSSERVICO,
	...
	public static class NfeStatusServicoNF2Result implements
			org.apache.axis2.databinding.ADBBean {
		...
		public org.apache.axiom.om.OMElement getOMElement(
			...
			org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
				...
				public void serialize(
						org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
						throws javax.xml.stream.XMLStreamException {
					NfeStatusServicoNF2Result.this.serialize(MY_QNAME, factory,
							xmlWriter);
				}
			};
			return new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "nfeStatusServicoNF2Result", xmlWriter);
				}
							...
							if (!"nfeStatusServicoNF2Result".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (NfeStatusServicoNF2Result) ExtensionMapper
	...
	private org.apache.axiom.om.OMElement toOM(
		...
		try {
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2.NfeStatusServico2Stub.NfeStatusServicoNF2Result.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private org.apache.axiom.om.OMElement toOM(
		...
		try {
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2.NfeStatusServico2Stub.NfeCabecMsgE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2.NfeStatusServico2Stub.NfeDadosMsg.class
					.equals(type)) {

				return br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2.NfeStatusServico2Stub.NfeDadosMsg.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2.NfeStatusServico2Stub.NfeStatusServicoNF2Result.class
					.equals(type)) {

				return br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2.NfeStatusServico2Stub.NfeStatusServicoNF2Result.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2.NfeStatusServico2Stub.NfeCabecMsgE.class
					.equals(type)) {

				return br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2.NfeStatusServico2Stub.NfeCabecMsgE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
