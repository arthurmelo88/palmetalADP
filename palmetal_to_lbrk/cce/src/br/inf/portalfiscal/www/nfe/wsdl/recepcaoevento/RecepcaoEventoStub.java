/**
 * RecepcaoEventoStub.java This file was auto-generated from WSDL by the Apache
 ...
 * 				<li>auto-generated from WSDL by the Apache
 * 
 * 	@version $Id: RecepcaoEventoStub.java, v1.0 2012/05/20 14:29:58 PM, ralexsander Exp $
 */
...
public class RecepcaoEventoStub extends org.apache.axis2.client.Stub
{
	...
	public static void setAmbiente(MLBRNFeWebService ws)
	{
	 ...
	 * @param nfeCabecMsg1
	 */
	public void startnfeRecepcaoEvento(br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg nfeDadosMsg0,
			br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE nfeCabecMsg1,
	...
	throws java.rmi.RemoteException
	{
		...
		env = toEnvelope(getFactory(_operationClient.getOptions()
				...
				optimizeContent(new javax.xml.namespace.QName(
						"http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento",
						"nfeRecepcaoEvento")), new javax.xml.namespace.QName(
						"http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento",
						"nfeRecepcaoEvento"));
				...
				throws org.apache.axis2.databinding.ADBException
		{
					...
					this, MY_QNAME)
			{
				...
				public void serialize(
						...
						throws javax.xml.stream.XMLStreamException
				{
					NfeRecepcaoEventoResult.this.serialize(MY_QNAME, factory,
							xmlWriter);
				}
			};
			return factory.createOMElement(dataSource, MY_QNAME);
					...
					for (int i = 0; i < reader.getAttributeCount(); i++)
					{
								...
								.getAttributeLocalName(i)))
						{
							...
							org.apache.axiom.om.OMAttribute attr = factory
									.createOMAttribute(reader
											.getAttributeLocalName(i), factory
											.createOMNamespace(
			...
			if (localVersaoDadosTracker)
			{
				...
				if (!namespace.equals(""))
				{
					...
					if (prefix == null)
					{
						...
						xmlWriter
								.writeStartElement(prefix, "versaoDados", namespace);
						xmlWriter.writeNamespace(prefix, namespace);
						xmlWriter.setPrefix(prefix, namespace);
			...
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		}
		catch (org.apache.axis2.databinding.ADBException e)
		{
			...
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		}
		catch (org.apache.axis2.databinding.ADBException e)
		{
			...
			throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			...
			if (br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
