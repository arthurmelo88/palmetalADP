 ...
 */
public class VGenBilling extends GenBilling implements FormPanel, ActionListener, TableModelListener, ASyncProcess
{
	/** @todo withholding */
	...
	private void exportBilling ()
	{
		...
		try
		{
			...
			exportBilling (miniTable, saveFile.getParent() , (KeyNamePair) fieldBankAccount.getSelectedItem());
